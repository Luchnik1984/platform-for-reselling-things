...
### Sprint9 - Расширение ImageServise и настройка статических ресурсов
...
### Sprint10 - Оптимизация и рефакторинг
...
-  **ЭТАП 3:**
- **Базовые сервисы:** 1/6 готово (17%)
- **Кастомные исключения:** 6/6 готово (100%)
- **Глобальная обработка исключений** 0/1 
- **Этап 3:** 1/10 UserStories (10%)

-  **ЭТАП 4:**
- **Статический доступ к изображениям** 0/1
- **Интеграционные тесты сервисов** 0/? (0%)
- **Интеграционные тесты контроллеров** 0/? (0%)
- **Unit-тесты сервисов** 0/? (0%)
- **Логирование** 0/1
- **Этап 4:** 9/9 UserStories (0%)
